...
public class Mountains extends Applet{
	...
	for(int k = 0; k < 400000; k++) {
		...
		int R = (int) Math.round(Math.random()*15)+30;//Converts random number to integer so can be used by rgb values
		int B = 0;
	...
	farmountains.addPoint(328, 295);farmountains.addPoint(364, 296);farmountains.addPoint(398, 294);farmountains.addPoint(413, 306);farmountains.addPoint(466, 322);farmountains.addPoint(498, 338);farmountains.addPoint(542, 360);farmountains.addPoint(608, 376);farmountains.addPoint(607, 376);farmountains.addPoint(939, 393);farmountains.addPoint(637, 637);farmountains.addPoint(296,637);
